...
public class signintab_frag extends Fragment {

    EditText Username,Password;
    Button button;int j=0;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ViewGroup root= (ViewGroup) inflater. inflate(R.layout.signintab_frag,container,false);


        Username =root.findViewById(R.id.txtUsername);
        Password =root. findViewById(R.id.txtPassword);
        button= root.findViewById(R.id.btnReg);
